...
def roll_dice(num_rolls, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    total,times,pig=0,num_rolls,False
    while times!=0:
         times=times-1
         outcome=dice()
         if outcome==1:
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
   ...
   # score0,score1,who=bid_for_start(bid0,bid1, goal=GOAL_SCORE)
    "*** YOUR CODE HERE ***"
    while score0 < goal and score1 < goal:
        strat0 = strategy0(score0,score1)
        strat1 = strategy1(score1,score0)
        score0 += take_turn(strat0, score1, select_dice(score0,score1))
        if score0>=goal:
            break
        else:
            score1 += take_turn(strat1, score0, select_dice(score1, score0))
...
def average_win_rate(strategy, baseline=always(5)):
...
def run_experiments():
    ...
    if False: # Change to True to test always(8)
        print('always_roll(8) win rate:', average_win_rate(always(8)))
